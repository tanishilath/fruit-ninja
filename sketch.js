...
function setup(){
  ...
  backgroundn = createSprite(300,300,40,40);
  backgroundn.scale = 4;
  ...
  gameover = createSprite(330,290,30,30);
...
function fruits(){
if (frameCount%50 === 0){
 var fruit = createSprite(600,Math.round(random(600,10)),20,20);
    fruit.scale =0.2;
...
function enemy(){
  if( frameCount%100===0){
 var  enemy = createSprite(600,200,20,20);
